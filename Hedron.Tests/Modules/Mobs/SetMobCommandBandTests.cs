...
{
    /// <summary>
    /// Tier 2 — <c>band</c> property-branch tests for <see cref="SetMobCommand"/>.
    ///
    /// Coverage contract: docs/implementation-plans/ascension.md (WP-3, Tier 2) — the
    /// <c>setmob band</c> dual-write assertion and out-of-range rejection.
    /// </summary>
