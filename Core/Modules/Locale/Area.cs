...
namespace Core.Modules.Locale
{
	public class Area : CacheableObject, ICopyableObject<Area>, IEntity //, ILocale
	{
		...
		/// <summary>
		/// A list of curated items that can drop in this area
		/// </summary>
		[JsonConverter(typeof(EntityContainerPropertyConverter))]
		[JsonProperty]
		public EntityContainer CuratedItems { get; protected set; } = new EntityContainer();

		/// <summary>
		/// A list of mobs that can randomly spawn in this area
		/// </summary>
		[JsonConverter(typeof(EntityContainerPropertyConverter))]
		[JsonProperty]
		public EntityContainer SpawnableMobs { get; protected set; } = new EntityContainer();

		/// <summary>
		/// A list of autogenerated prototype mobs for this area
		/// </summary>
		[JsonConverter(typeof(EntityContainerPropertyConverter))]
		[JsonProperty]
		...
		public static Area NewPrototype(uint parentID)
		{
			...
			newArea.CuratedItems.CacheType = CacheType.Prototype;
			newArea.SpawnableMobs.CacheType = CacheType.Prototype;
			...
			newArea.CuratedItems.PrototypeParents.Add((uint)newArea.Prototype);
			newArea.SpawnableMobs.PrototypeParents.Add((uint)newArea.Prototype);

			DataAccess.Add<EntityContainer>(newArea.Rooms, CacheType.Prototype);
			DataAccess.Add<EntityContainer>(newArea.CuratedItems, CacheType.Prototype);
			DataAccess.Add<EntityContainer>(newArea.SpawnableMobs, CacheType.Prototype);
		...
		public static Area NewInstance(bool withPrototype, uint parentID)
		{
			...
			else
			{
				...
				DataAccess.Add<EntityContainer>(newArea.CuratedItems, CacheType.Instance);
				DataAccess.Add<EntityContainer>(newArea.SpawnableMobs, CacheType.Instance);
