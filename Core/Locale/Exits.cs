	...
	public sealed class RoomExits
	{
		...
		public static void LinkPrototypeRoomExits(List<uint> roomIDs = null)
		{
			...
			foreach (var sourceRoom in protoRoomlist)
			{
				...
				sourceRoom.Exits.North = targetRoomNorth != null ? targetRoomNorth.Prototype : default;
				sourceRoom.Exits.East = targetRoomEast != null ? targetRoomEast.Prototype : default;
				sourceRoom.Exits.South = targetRoomSouth != null ? targetRoomSouth.Prototype : default;
				sourceRoom.Exits.West = targetRoomWest != null ? targetRoomWest.Prototype : default;
				sourceRoom.Exits.Up = targetRoomUp != null ? targetRoomUp.Prototype : default;
				sourceRoom.Exits.Down = targetRoomDown != null ? targetRoomDown.Prototype : default;
			}
		}
		...
		public static void LinkInstancedRoomExits(List<uint> roomIDs = null)
		{
			...
			foreach (var sourceRoom in roomlist)
			{
				...
				// Assign the link of the instanced room to the appropriate instanced rooms
				sourceRoom.Exits.North = targetRoomNorth.Count > 0 ? targetRoomNorth.ElementAt(0).Instance : default;
				sourceRoom.Exits.East = targetRoomEast.Count > 0 ? targetRoomEast.ElementAt(0).Instance : default;
				sourceRoom.Exits.South = targetRoomSouth.Count > 0 ? targetRoomSouth.ElementAt(0).Instance : default;
				sourceRoom.Exits.West = targetRoomWest.Count > 0 ? targetRoomWest.ElementAt(0).Instance : default;
				sourceRoom.Exits.Up = targetRoomUp.Count > 0 ? targetRoomUp.ElementAt(0).Instance : default;
				sourceRoom.Exits.Down = targetRoomDown.Count > 0 ? targetRoomDown.ElementAt(0).Instance : default;
			}
		}
	}
}