...
> Implemented on branch `claude/quizzical-robinson-3ac390` (Phase A PR #80; Phase B this PR). Full feature spec: [`../../use-cases/items-and-inventory.md`](../../use-cases/items-and-inventory.md).
