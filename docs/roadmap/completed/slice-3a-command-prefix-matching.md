...
> Implemented and merged on `master` (PR #68). The full feature spec lives in [`../../use-cases/command-prefix-matching.md`](../../use-cases/command-prefix-matching.md). This file records the as-built state and any deviations from the spec.
