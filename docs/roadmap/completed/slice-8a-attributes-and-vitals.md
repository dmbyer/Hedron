...
> Implemented on branch `claude/serene-jepsen-3b5701`. Living design: [`../../features/character-stats/attribute-system.md`](../../features/character-stats/attribute-system.md).
