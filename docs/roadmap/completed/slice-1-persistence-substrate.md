...
> Implemented and merged on `master`. The full feature spec lives in [`../../use-cases/persistence-substrate.md`](../../use-cases/persistence-substrate.md). This file records the as-built state and any deviations from the spec.
