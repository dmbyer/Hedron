...
- [`../../implementation-plans/balance-simulator.md`](../../implementation-plans/balance-simulator.md) — the five-sub-slice program this is `sim-2`/`sim-3`/`sim-4` of (`sim-5` conformance tooling remains).
