...
7. **Apply to live.** The "Apply" action calls `IWorldContentLoader.ReloadAsync()` — [Flow 5 (content reload)](../../architecture/flows/flow-05-content-reload.md). New templates are seeded; existing live entities are not mutated.
