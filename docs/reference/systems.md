...
Registered as a singleton in `SimulationModule.AddSimulationModule`. Implemented (simulation-engine-core slice sim-2; save/list extended sim-3).
...
Registered as a singleton in `SimulationModule.AddSimulationModule`. Implemented (simulation-engine-core slice sim-2; cancellation + progress callback extended sim-3).
