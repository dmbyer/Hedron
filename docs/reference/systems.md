...
**Location:** `Core/Systems/IPowerBudgetSystem.cs` · `PowerBudgetSystem.cs` · `PowerBudgetTunables.cs` · `PowerSnapshot.cs` · `PowerBand.cs` · `PowerRange.cs`
