...
- [`docs/implementation-plans/combat.md`](../../implementation-plans/combat.md) — slice 9 spec; [Flow 16](flow-16-heartbeat-tick.md) — heartbeat trigger; [`docs/implementation-plans/prompt-and-output-batching.md`](../../implementation-plans/prompt-and-output-batching.md) — output batching spec
