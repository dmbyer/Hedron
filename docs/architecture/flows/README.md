...
| 29 | [Content-tooling journey (bulk generate · offline edit · standards editing · conformance fitter · visual grid editor)](flow-29-bulk-content-generation.md) | `dotnet run --project Server -- generate --profile <path>` or designer edits in `Hedron.Web` | content-tooling platform (T1, T2; Standards page added sim-1; conformance fitter added sim-5; visual grid area editor added world-editor-grid); source: [../../features/admin-authoring/admin-authoring.md](../../features/admin-authoring/admin-authoring.md) |
