...
**Next:** sim-1 and sim-2 shipped — see [`../roadmap/completed/balance-standards-registry.md`](../roadmap/completed/balance-standards-registry.md) / [`../roadmap/completed/simulation-engine-core.md`](../roadmap/completed/simulation-engine-core.md) and [`../features/progression/power-budget-system.md`](../features/progression/power-budget-system.md) / [`../features/simulation/simulation.md`](../features/simulation/simulation.md). Sub-slices sim-3…sim-5 each get their own plan framed against this seed via `/new-plan`, starting with `sim-3` (editor integration).
