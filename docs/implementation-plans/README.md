...
| `planned` | [`progression-and-balance.md`](progression-and-balance.md) | Progression & Balance — program brief (slices 3–5 remain) |
| `planned` | [`power-budget-inspector.md`](power-budget-inspector.md) | Progression & Balance `prog-3` — power model + balance inspector (spec-passed, ready to implement) |
