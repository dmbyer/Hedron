...
| `planned` | [`balance-simulator.md`](balance-simulator.md) | Balance Simulator & Workbench — program seed (prog-4, sub-slices sim-3…sim-5 remain; sim-1/sim-2 shipped) |
| `planned` | [`sim-editor-integration.md`](sim-editor-integration.md) | sim-3 — Simulation editor integration (Blazor Simulation page, run service, entry points, baseline sweep) |
