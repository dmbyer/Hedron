...
- [`combat.md`](../features/combat/combat.md) / [`stat-system.md`](../features/character-stats/character-stats.md) / [`effect-substrate.md`](../features/effects/effects.md) / [`ability-substrate.md`](../features/abilities/abilities.md) — built consumers and the registries this slice retrofits.
