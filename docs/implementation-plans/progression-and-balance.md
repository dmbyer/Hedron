...
| **4** | **Simulation harness** | `Hedron.Sim` project (parameter-sweep runner, statistical reporting, combatant-policy seam), promoted CI regression invariants | 3b (uses the revised power oracle, done) |
